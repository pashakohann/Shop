...
/**
 * Strings for our exceptions from Dao account
 */
public interface DaoAccountExceptionString {
    ...
    String SQL_DELETE_ACCOUNT_EXCEPTION = "Failed to delete account";
    String SQL_FIND_ALL_ACCOUNTS_EXCEPTION = "Fail to find  accounts";
    String FIND_ACCOUNT_BY_ID_EXCEPTION = "Account isn't found";
