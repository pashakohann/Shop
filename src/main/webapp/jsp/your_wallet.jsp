...
<fmt:message bundle="${loc}" key = "backToMenu" var="backToMenu"/>
<fmt:message bundle="${loc}" key = "topUp" var="topUp"/>
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
     ...
     <c:when test="${sessionScope.currentUser.getRole() eq 'ADMIN'}">
       ...
       <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/shop?command=show_profile_command">${yourProfile}</a></li>
        <li class="breadcrumb-item active" aria-current="page">${yourWallet}</li>
      </c:when>
    ...
    <table class="table table-dark table-striped">
      <table class="table">
         ...
         <tbody>
          ...
          <tr>
         <td>
          <button submit="button" class="button" style="color:white;background-color: rebeccapurple;">${topUp}</button>
